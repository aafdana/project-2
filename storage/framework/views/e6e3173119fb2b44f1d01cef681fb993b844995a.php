<aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="<?php echo e(url('/user')); ?>"> <i class="menu-icon fa fa-list"></i>Daftar User</a>
                    </li>
    ...
    </aside> <?php /**PATH C:\xampp74\htdocs\alfath\resources\views/layouts/include/_sidebar.blade.php ENDPATH**/ ?>