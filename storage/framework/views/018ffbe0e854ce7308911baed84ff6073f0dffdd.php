<aside id="left-panel" class="left-panel">
                    ...
                    <li class="menu-title">Tabel Aktor</li><!-- /.menu-title -->
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-list"></i><a href="<?php echo e(url('/customer')); ?>">Lihat Customer</a></li>
                                <li><i class="fa fa-plus"></i><a href="<?php echo e(url('/tambahcustomer')); ?>">Tambah Customer</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-list"></i><a href="<?php echo e(url('/pedagang')); ?>">Lihat Pedagang</a></li>
                                <li><i class="fa fa-plus"></i><a href="<?php echo e(url('/pedagang/create')); ?>">Tambah Pedagang</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
    ...
    </aside><?php /**PATH C:\xampp74\htdocs\Hope\resources\views/layouts/include/_sidebar.blade.php ENDPATH**/ ?>