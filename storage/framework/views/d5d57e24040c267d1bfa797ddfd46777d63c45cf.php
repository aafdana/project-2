<div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="<?php echo e(asset('images/logo-hope.png')); ?>" alt="Hope"></a>
    ...
    </div><?php /**PATH C:\xampp74\htdocs\Hope\resources\views/layouts/include/_navbar.blade.php ENDPATH**/ ?>