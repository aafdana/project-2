                    ...
                    <div class="card">
                        <div class="card-header">Edit Mahasiwa</div>
                            <div class="card-body card-block">
                                ...
                                <form action="/edit/{{$customer->id_mahasiswa}}" method="post">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="NIM"
                                                    placeholder="" value="{{$customer->NIM}}" required>
                                    ...
                                    <div class="row form-group">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="Nama_Mahasiswa"
                                                    placeholder="" value="{{$customer->Nama_Mahasiswa}}" required>    
                                            </div>
                                            <div class="col-md-6">
                                                <label for="exampleFormControlInput1">Jenis Kelamin</label>
                                                <input type="text" class="form-control" name="Jenis_Kelamin"
                                                    placeholder="" value="{{$customer->Jenis_Kelamin}}" required>    
                                            </div>    
                                    </div>    
                                ...
                                <div class="row form-group">
                                    <div class="col-md-8">
                                                ...
                                                <input type="text" class="form-control" name="Alamat"
                                                    placeholder="" value="{{$customer->Alamat}}" required>
                                    </div>
                                    <div class="col-md-6">
                                                <label for="exampleFormControlInput1" style="color:grey">Asal Sekolah</label>
                                                <input type="text" class="form-control" name="Asal_Sekolah" value="{{$customer->Asal_Sekolah}}">    
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="TTL" value="{{$customer->TTL}}">    
                                    </div>
                                    <div class="col-md-6">
                                                <label for="exampleFormControlInput1" style="color:grey">Kode Prodi</label>
                                                <input type="text" class="form-control" name="Kode_Prodi" value="{{$customer->Kode_Prodi}}">    
                                    </div>
                                </div>
